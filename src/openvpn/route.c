                       ...
                       const bool is_multipoint)
{
    ...
    if (is_multipoint && is_dco_enabled)
    {
        return true;
    }
          ...
          const bool is_multipoint)
{
    ...
    gateway_needed = is_gateway_needed_ipv4(r, rgi, tt, tt->backend_driver == DRIVER_DCO, is_multipoint);
               ...
               openvpn_net_ctx_t *ctx, const bool is_multipoint)
{
    ...
    gateway_needed = is_gateway_needed_ipv6(r6, tt, network, tt->backend_driver == DRIVER_DCO, is_multipoint);
             ...
             const bool is_multipoint)
{
    ...
    bool gateway_needed = is_gateway_needed_ipv4(r, rgi, tt, tt->backend_driver == DRIVER_DCO, is_multipoint);
